...
**Address Tag** is a craftable item used for specifying the recipient [address](@envelope:address) on a mailable item.\
...
<div style={{ display: "flex", flexWrap: "wrap", width: "100%", alignItems: "flex-start", marginBottom: "-2rem" }}>
    ...
    <center style={{ alignItems: 'top', marginLeft: "1rem", marginRight: "0.2rem" }}>
        <ModAsset location="envelope:gui/address_tag" width={450} style={{ borderRadius: "10px" }} />
