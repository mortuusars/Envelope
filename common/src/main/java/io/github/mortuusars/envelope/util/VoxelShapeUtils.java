...
/**
 * Thanks to Mekanism for this. <a href="https://github.com/mekanism/Mekanism/blob/1.18.x/src/main/java/mekanism/common/util/VoxelShapeUtils.java">...</a>
 * They have MIT licence - I hope it's ok that I yoinked some of their methods.
 */
