...
public class NewPackageScreen extends AbstractContainerScreen<NewPackageMenu> {
    public static final ResourceLocation TEXTURE = Envelope.resource("textures/gui/packing.png");

    public NewPackageScreen(NewPackageMenu menu, Inventory playerInventory, Component title) {
