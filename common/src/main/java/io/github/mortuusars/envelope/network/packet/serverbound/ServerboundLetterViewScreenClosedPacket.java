...
public record ServerboundLetterViewScreenClosedPacket(int slot) implements Packet {
    public static final ResourceLocation ID = Envelope.resource("letter_view_screen_closed");
    public static final Type<ServerboundLetterViewScreenClosedPacket> TYPE = new Type<>(ID);

    public static final StreamCodec<RegistryFriendlyByteBuf, ServerboundLetterViewScreenClosedPacket> STREAM_CODEC = StreamCodec.composite(
          ByteBufCodecs.VAR_INT, ServerboundLetterViewScreenClosedPacket::slot,
          ServerboundLetterViewScreenClosedPacket::new
    );
