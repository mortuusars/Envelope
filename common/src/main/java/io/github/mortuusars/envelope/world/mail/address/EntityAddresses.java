...
public class EntityAddresses {
    ...
    public static final ResourceKey<EntityAddressDefinition> TRADE_OFFICE =
          ResourceKey.create(Envelope.Registries.ENTITY_ADDRESS, Envelope.resource("trade_office"));
    ...
    public static void bootstrap(BootstrapContext<EntityAddressDefinition> context) {
        ...
        context.register(TRADE_OFFICE,
              new EntityAddressDefinition(Component.translatable("address.envelope.trade_office")));
    }
}
